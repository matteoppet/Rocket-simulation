...
class RocketCalculation:
    ...
    def get_mass_flow_rate(self):
        # Solid rocket engines: 200-300 seconds
        # Liquid rocket engines: 300-450 seconds
        # Ion rocket engines: 3000+ seconds 
        return self.current_thrust_power/(300 * GRAVITY)
    @property
...
class Rocket(pygame.sprite.Sprite, RocketCalculation):
    ...
    def controls(self, dt):
        ...
        if keys[pygame.K_w]:
            ...
            if self.current_thrust_percentage > 0:
                self.current_thrust_percentage -= 1
